...
3. **Social Security is enough** (Program is "wobbly" and only replaces partial income)
4. **Working longer reduces savings needs** (COVID proved you can't always choose)
5. **Pay off all debt first** (2.25% mortgage vs. investment returns = basic math)
6. **Legacy planning can wait** (Mike's father's tragic example proves otherwise)
...
Without proper documentation, the estate immediately went to probate. Legal fees began accumulating daily.

**2. Forced Asset Sales**
To pay mounting legal costs:
...
**3. Life Insurance Lapse**
The family discovered their life insurance policy had lapsed just three months before Mike's father died. **Zero payout when they needed it most.**

**4. Total Financial Chaos**
Mike's mother suddenly faced:
...
**5. Long-Term Struggles**
The financial devastation lasted over a decade:
...
**1. Assuming federal estate tax won't apply**
With inflation and rising asset values, more Utah estates now subject to federal taxation. Current federal exemption levels won't protect everyone.

**2. Overlooking Utah's family dynamics**
Large Utah families with multiple children create complex legacy distribution challenges. Equal doesn't always mean fair.

**3. Missing charitable opportunities**
Utah's giving culture provides significant tax advantages through:
...
IRAs and 401(k)s represent most Utah retirees' wealth, but poor beneficiary planning creates massive tax burdens for heirs.
...
**The challenge:**
Robert thought he needed to take RMDs from every account separately, creating:
...
**The problem most Utah families don't see coming:**
70% of retirees' wealth sits in tax-deferred accounts (401k, traditional IRAs). When you pass away, your children inherit a "tax time bomb."
...
**Example: Salt Lake Valley Family Impact**
**Scenario:** Utah couple leaves $500,000 traditional IRA to their 45-year-old son, a successful Park City hotel manager.
...
**Why charitable planning matters more in Utah:**
Utah residents give higher percentages of income to charity than any other state. This creates unique legacy planning opportunities.
...
**Longer lifespans than family history suggests:**
Utah's health-conscious culture, combined with medical advances, means many Utah retirees live longer than family precedents indicate.
...
1. **Create basic will immediately** (even handwritten will valid in Utah)
2. **Healthcare directive is most urgent** (medical decisions can't wait)
3. **Financial power of attorney** (spouse needs account access)
4. **Beneficiary updates** (can be done quickly by phone)
5. **Document location list** (where important papers are kept)
