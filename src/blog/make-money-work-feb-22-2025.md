---
title: "Make Your Money Work: From Earning to Learning"
...
**Real Utah Example:**
In 2008, retirees using this strategy took their income from protected annuities earning 0% while their stock investments fell 40-50%. By 2012, their stock investments had not only recovered but exceeded their 2007 highs. Meanwhile, they never missed an income payment or had to sell at a loss.
...
2. Traditional 401(k)/IRA second (managing tax brackets)  
3. Roth IRA last (maximizing tax-free growth)
...
With Utah's strong economy and lower cost of living compared to coastal areas, you might be able to afford slightly more conservative allocations than retirees in higher-cost states.

**The Two-Bucket Solution:**
This is where our bucket strategy becomes powerful. You can have the security you want (protected bucket) while still allowing some money to grow ahead of inflation (growth bucket). When markets are down, you take income from the safe bucket and leave the growth money alone to recover.

**Risk Tolerance vs. Risk Capacity:**
Your risk tolerance (how much volatility you can emotionally handle) might be different from your risk capacity (how much risk you can afford to take based on your financial situation). Sometimes people are overly conservative because they have more than enough money, and sometimes they need to take more risk than they're comfortable with because they don't have enough.
...
1. **Income Plan:** How will you generate reliable paycheck replacements?
2. **Tax Strategy:** How will you minimize lifetime tax burden?
3. **Inflation Plan:** How will you maintain purchasing power over 30+ years?
4. **Healthcare Plan:** How will you fund increasing medical expenses?
5. **Long-term Care Plan:** How will you pay for assistance if needed?
6. **Spouse Plan:** What happens when the first spouse passes away?
7. **Legacy Plan:** What do you want to leave to family or charity?
...
**Tags:** #RetireRightRadio #UtahRetirement #RetirementIncome #MakeMoneyWork #TwoBucketStrategy #RetirementPlanning #TaxStrategy #RothConversions #RetirementMoneyMap #CapitalWealthAdvisors #MikeStevens #PortfolioToPaycheck #RetirementDistribution #UtahRetirees #RetirementCashFlow