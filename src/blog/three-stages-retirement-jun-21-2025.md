...
We model how your plan performs during prolonged economic downturns similar to 2008-2009 or the early 1980s. Questions we answer:
...
With national debt levels and changing political landscapes, tax policy shifts are nearly inevitable. We stress test for:
...
**4. Inflation Spikes**
Remember the 1970s when inflation peaked above 14%? We test what happens if inflation jumps to 6-8% for extended periods:
...
International events can significantly impact U.S. markets and the dollar's strength:
...
Healthcare costs have historically risen faster than general inflation. We model scenarios where healthcare costs increase 8-10% annually:
- Long-term care cost projections
- Medicare supplement and out-of-pocket maximums
- Prescription drug cost escalation

**7. Interest Rate Environment Changes**
Whether rates rise dramatically or fall to zero (or negative), your plan needs to work:
...
**8. Longevity Risk**
What if you live much longer than expected? We test scenarios where one or both spouses live to 95-100:
...
**Southern Utah Memory Care Costs**:
Based on current market rates in the St. George area:
...
**Immediate Steps**:
1. **Comprehensive cognitive baseline**: Get neuropsychological testing now while healthy to establish baseline cognitive function
2. **Legal documents**: Ensure powers of attorney, healthcare directives, and HIPAA authorizations are current
3. **Family discussions**: Talk with adult children about preferences for care

**Financial Preparation**:
1. **Living benefits on life insurance**: Access death benefits for long-term care needs
2. **Long-term care rider on annuities**: Some annuities double benefits if long-term care is needed
3. **Health Savings Account maximization**: If eligible, HSAs provide triple tax advantages for healthcare costs
...
Memory care planning is most effective when done 5-10 years before potential need. At 72, you're in the ideal planning window. Waiting until symptoms appear severely limits your options and choices.
...
1. **Sequence of returns risk**: What if poor returns occur early in retirement when you're taking distributions?
2. **Extended bear market**: Can your plan survive a 2008-style downturn lasting 2-3 years?
3. **Inflation spike**: What happens if inflation jumps to 6-8% for several years?
4. **Interest rate changes**: How do rising or falling rates affect different parts of your portfolio?
...
Begin conversations by explaining your values and goals rather than jumping into asset distribution. Share what's important to you about family unity, legacy, and taking care of each other.
...
1. **Values discussion**: What do you want your legacy to represent?
2. **Practical matters**: Healthcare wishes, decision-making preferences
3. **Asset overview**: General picture without specific dollar amounts initially
4. **Specific bequests**: Who gets what and why
5. **Questions and concerns**: Allow time for family input
...
The earlier you create a comprehensive plan, the more options and flexibility you'll have. Waiting until you're already retired or experiencing health issues severely limits your choices and strategies.
...
For the **next five callers**, we'll create a personalized Retirement Money Map� at no cost and with no obligation whatsoever. This comprehensive analysis covers every aspect of your retirement security:
...
**Tags**: #RetireRightRadio #UtahRetirement #RetirementPlanning #CapitalWealthAdvisors #GoGoYears #SlowGoYears #NoGoYears #RetirementMoneyMap #HealthcareCosts #LongTermCare #SocialSecurityMaximization #TaxPlanning #InflationPlanning #EstatePlanning #LivingBenefits #MikeStevens #RetireUtah #UtahFinancialPlanning #RetirementStages #FinancialSecurity #RetirementIncome #WasatchFront #SaltLakeCity #StGeorge #Logan #Provo #ParkCity
