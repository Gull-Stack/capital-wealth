...
export default async function handler(req, res) {
  ...
  try {
    const {
      ...
      // Federal webinar (June 11, 2026) fields — additive, optional except
    ...
    if (SENDGRID_API_KEY) {
      ...
      if (is10Things) {
        ...
        emailSubject = 'You\'re Registered: Federal Benefits Webinar — June 11, 2026';
        confirmationHtml = `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <div style="background: linear-gradient(135deg, #16253C 0%, #0f2b4a 100%); padding: 32px; text-align: center; color: white;">
              ...
              <p style="color: rgba(255,255,255,0.92); margin: 12px 0 0 0; font-size: 16px;">Federal Benefits Webinar — FERS Benefits: The Full Picture</p>
            </div>
            <div style="padding: 32px; background: #ffffff;">
              ...
              <div style="background: #f8f9fb; padding: 20px; border-radius: 8px; border-left: 4px solid #C4A82A; margin: 16px 0 24px;">
                ...
                <p style="margin: 6px 0; font-size: 15px; color: #1a1a1a;"><strong>Date:</strong> Thursday, June 11, 2026</p>
              ...
              <div style="background: #16253C; color: #fff; padding: 18px 20px; border-radius: 8px; margin: 0 0 24px; text-align: center;">
                ...
                <p style="margin: 12px 0 0 0; color: rgba(255,255,255,0.72); font-size: 12px; line-height: 1.5;">Save this email — we'll also send a reminder the morning of June 11 with the same link.</p>
              </div>
              ` : `
              <p style="font-size: 15px; color: #4b5563; line-height: 1.65;">We'll send a reminder 3 days out and your unique Zoom join link the morning of June 11. If you can't attend live, the full replay will be emailed to you within 48 hours.</p>
              `}
      ...
      if (is10Things) {
        ...
        notificationSubject = `${isHotLead ? '🔥' : '🎯'} Federal Webinar Registration: ${leadData.name} — June 11, 2026 (${yearsLabel})`;
        notificationHtml = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <div style="background: #16253C; padding: 20px; text-align: center;">
              ...
              <p style="color: rgba(255,255,255,0.85); margin: 8px 0 0 0;">June 11, 2026 — FERS Benefits: The Full Picture</p>
            </div>
            <div style="padding: 28px; background: #f9f9f9;">
